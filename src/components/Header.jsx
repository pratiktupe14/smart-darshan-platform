      ...
      <div className="max-w-[80rem] mx-auto px-margin-mobile md:px-margin-desktop h-20 flex justify-between items-center">
        ...
        <div className="flex items-center gap-md">
          <select 
            ...
            className="font-label-sm text-label-sm bg-surface border border-on-surface/10 rounded-xl px-3 py-2 text-on-surface hover:border-primary focus:outline-none transition-all cursor-pointer"
          ...
          <Link className="font-button text-button px-6 py-3 rounded-xl bg-primary text-on-primary shadow-lg shadow-primary/20 hover:scale-[1.02] active:scale-95 transition-all" to="/dashboard/book">
            {t('bookDarshan')}
          </Link>
        </div>
      </div>
