        ...
        {isAdminView ? (
          <>
            <div className="flex items-center gap-3 px-2 mb-6">
              ...
              <div>
                <p className="font-label-md text-label-md font-bold text-primary">शिव अर्धः नारेश्वरी नाग ज्योतिर्लिंग श्री क्षेत्र बिलमाळ (तुलसिगड) Admin</p>
        ...
        <footer className="w-full mt-auto py-10 px-4 md:px-10 bg-surface-container-highest border-t border-outline-variant">
          <div className="max-w-[1600px] mx-auto flex flex-col md:flex-row justify-between items-center gap-8 text-center md:text-left">
            <div className="flex flex-col gap-2">
              <h2 className="text-2xl font-extrabold text-primary">शिव अर्धः नारेश्वरी नाग ज्योतिर्लिंग श्री क्षेत्र बिलमाळ (तुलसिगड)</h2>
              <p className="text-sm text-on-surface-variant">© 2024 शिव अर्धः नारेश्वरी नाग ज्योतिर्लिंग श्री क्षेत्र बिलमाळ (तुलसिगड). All Rights Reserved.</p>
            </div>
