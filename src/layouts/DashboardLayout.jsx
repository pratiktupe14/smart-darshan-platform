    ...
    <div className="font-body text-on-background bg-background min-h-screen flex flex-col">
          ...
          <>
            ...
            <nav className="space-y-1">
              ...
              <a className="flex items-center gap-3 px-4 py-3 text-on-surface-variant hover:bg-surface-container-high rounded-lg transition-all font-bold font-label-md text-label-md" href="#">
                ...
                <span className="text-sm">{t('staffManagement')}</span>
              </a>
              <a className="flex items-center gap-3 px-4 py-3 text-on-surface-variant hover:bg-surface-container-high rounded-lg transition-all font-bold font-label-md text-label-md" href="#">
              ...
              <a className="flex items-center gap-3 px-4 py-3 text-on-surface-variant hover:bg-surface-container-high rounded-lg transition-all font-bold font-label-md text-label-md" href="#">
                ...
                <span className="text-sm">{t('festivalManagement')}</span>
              </a>
      ...
      {isAdminView ? (
        <nav className="md:hidden fixed bottom-0 left-0 w-full bg-surface border-t border-outline-variant flex justify-around items-center h-16 z-50">
          ...
          <a className="flex flex-col items-center text-on-surface-variant hover:text-primary" href="#">
            <span className="material-symbols-outlined">settings</span>
